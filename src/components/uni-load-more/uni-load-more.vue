<template>
  <view class="uni-load-more" @click="onClick">
    ...
    <!-- #endif -->
    <view v-if="showText">
      <text class="uni-load-more__text" :style="{ color: color }" v-if="status === 'more'">
        {{ contentText.contentdown }}
      </text>
      <text class="uni-load-more__text" :style="{ color: color }" v-else-if="status === 'noMore'">
        {{ contentText.contentnomore }}
      </text>
      <text class="uni-load-more__text" :style="{ color: color }" v-else-if="status === 'loading'">
